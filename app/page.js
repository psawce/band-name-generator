...
const getTheme = (dark) => ({
  ...
  btnPrimaryBg:   dark ? "#f0f0f0" : "#111111",
  btnPrimaryText: dark ? "#111111" : "#ffffff",
  btnPrimaryBorder: dark ? "#f0f0f0" : "#111111",
  btnOutlineBg:   dark ? "#0e0e0e" : "#ffffff",
  btnOutlineText: dark ? "#f0f0f0" : "#111111",
  btnOutlineBorder: dark ? "#f0f0f0" : "#111111",
  btnGhostBg:     dark ? "#0e0e0e" : "#ffffff",
  btnGhostText:   dark ? "#888888" : "#555555",
  btnGhostBorder: dark ? "#333333" : "#cccccc",
  toggleBg:       dark ? "#f0f0f0" : "#111111",
  toggleText:     dark ? "#111111" : "#ffffff",
});
